...
--
-- Name: usuario_carrera; Type: TABLE; Schema: public
-- Vinculo entre una persona (usuarios) y las carreras donde trabaja.
--
...
ALTER TABLE public.usuario_carrera OWNER TO postgres;
